...
static void (*usiTwiOnStartSendingFunction) ();
static void (*usiTwiOnEndSendingFunction) ();
...
// assign callback function to START signal
void
usiTwiOnStartSending(
  void (*function) ()
)
{
  usiTwiOnStartSendingFunction = function;
}
...
{
  usiTwiOnEndSendingFunction = function;
}
...
ISR( USI_OVERFLOW_VECTOR )
{
  ...
  switch ( overflowState )
  {
    ...
    case USI_SLAVE_SEND_DATA:
	  ...
	  if (usiTwiOnStartSendingFunction != 0) usiTwiOnStartSendingFunction();
    ...
    case USI_SLAVE_REQUEST_REPLY_FROM_SEND_DATA:
      ...
      SET_USI_TO_READ_ACK( );
	  if (usiTwiOnEndSendingFunction != 0) usiTwiOnEndSendingFunction();
      break;
